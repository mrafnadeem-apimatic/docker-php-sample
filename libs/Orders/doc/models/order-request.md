...
|  --- | --- | --- | --- | --- | --- |
| `intent` | [`string(CheckoutPaymentIntentEnum)`](../../doc/models/checkout-payment-intent-enum.md) | Required | The intent to either capture payment immediately or authorize a payment for an order after order creation. | getIntent(): string | setIntent(string intent): void |

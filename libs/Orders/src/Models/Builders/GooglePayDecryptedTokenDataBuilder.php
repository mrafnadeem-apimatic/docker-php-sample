...
use OrdersLib\Models\GooglePayDecryptedTokenData;
...
class GooglePayDecryptedTokenDataBuilder
{
     ...
     */
    public static function init(string $authenticationMethod): self
    {
        return new self(new GooglePayDecryptedTokenData($authenticationMethod));
    }

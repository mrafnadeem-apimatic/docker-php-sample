...
class ThreeDSecureAuthenticationResponse implements \JsonSerializable
{
     ...
     * @factory \OrdersLib\Models\PAResStatusEnum::checkValue
     */
     ...
     * @factory \OrdersLib\Models\EnrollmentStatusEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->authenticationStatus)) {
            $json['authentication_status'] = PAResStatusEnum::checkValue($this->authenticationStatus);
        }
        if (isset($this->enrollmentStatus)) {
            $json['enrollment_status']     = EnrollmentStatusEnum::checkValue($this->enrollmentStatus);
        }

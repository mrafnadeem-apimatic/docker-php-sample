...
class Capture implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $disbursementMode = DisbursementModeEnum::INSTANT;
     ...
     *
     * @maps status
     * @factory \OrdersLib\Models\CaptureStatusEnum::checkValue
     */
     ...
     * @factory \OrdersLib\Models\DisbursementModeEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']                        = CaptureStatusEnum::checkValue($this->status);
        }
        ...
        if (isset($this->disbursementMode)) {
            $json['disbursement_mode']             = DisbursementModeEnum::checkValue($this->disbursementMode);
        }
        if (isset($this->links)) {

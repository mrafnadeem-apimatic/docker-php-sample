...
use PaypalRestApisLib\Authentication\ClientCredentialsAuthManager;
use PaypalRestApisLib\Controllers\OAuthAuthorizationController;
...
use PaypalRestApisLib\Utils\CompatibilityConverter;
use Unirest\Configuration;
use Unirest\HttpClient;

class PaypalRestApisClient implements ConfigurationInterface
{
    private $orders;
    ...
    /**
     * @see PaypalRestApisClientBuilder::init()
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = ClientBuilder::init(new HttpClient(Configuration::init($this)))
            ...
            ->userAgent('PayPal REST API PHP SDK, Version: 2.16.0, on OS {os-info}')
     ...
     *
     * @return PaypalRestApisClientBuilder PaypalRestApisClientBuilder instance
     */
    public function toBuilder(): PaypalRestApisClientBuilder
    {
        $builder = PaypalRestApisClientBuilder::init()
     ...
     *
     * @see PaypalRestApisClientBuilder::getConfiguration()
     */

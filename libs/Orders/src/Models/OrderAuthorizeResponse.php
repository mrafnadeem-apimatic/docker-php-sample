...
class OrderAuthorizeResponse implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $processingInstruction = ProcessingInstructionEnum::NO_INSTRUCTION;
     ...
     *
     * @maps intent
     * @factory \OrdersLib\Models\CheckoutPaymentIntentEnum::checkValue
     */
     ...
     * @factory \OrdersLib\Models\ProcessingInstructionEnum::checkValue
     */
     ...
     *
     * @maps status
     * @factory \OrdersLib\Models\OrderStatusEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->intent)) {
            $json['intent']                 = CheckoutPaymentIntentEnum::checkValue($this->intent);
        }
        if (isset($this->processingInstruction)) {
            $json['processing_instruction'] = ProcessingInstructionEnum::checkValue($this->processingInstruction);
        }
        if (isset($this->payer)) {

...
class PayPalWalletResponse implements \JsonSerializable
{
     ...
     *
     * @maps account_status
     * @factory \OrdersLib\Models\PayPalWalletAccountVerificationStatusEnum::checkValue
     */
     ...
     *
     * @maps phone_type
     * @factory \OrdersLib\Models\PhoneTypeEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->accountStatus)) {
            $json['account_status'] = PayPalWalletAccountVerificationStatusEnum::checkValue($this->accountStatus);
        }
        if (isset($this->name)) {
            $json['name']           = $this->name;
        }
        if (isset($this->phoneType)) {
            $json['phone_type']     = PhoneTypeEnum::checkValue($this->phoneType);
        }

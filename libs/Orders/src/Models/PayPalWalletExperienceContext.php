...
class PayPalWalletExperienceContext implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $shippingPreference = ShippingPreferenceEnum::GET_FROM_FILE;
     ...
     * @var string|null
     */
    private $landingPage = PayPalExperienceLandingPageEnum::NO_PREFERENCE;

    /**
     * @var string|null
     */
    private $userAction = PayPalExperienceUserActionEnum::CONTINUE_;

    /**
     * @var string|null
     */
    private $paymentMethodPreference = PayeePaymentMethodPreferenceEnum::UNRESTRICTED;
     ...
     * @factory \OrdersLib\Models\ShippingPreferenceEnum::checkValue
     */
     ...
     *
     * @maps landing_page
     * @factory \OrdersLib\Models\PayPalExperienceLandingPageEnum::checkValue
     */
     ...
     *
     * @maps user_action
     * @factory \OrdersLib\Models\PayPalExperienceUserActionEnum::checkValue
     */
     ...
     * @factory \OrdersLib\Models\PayeePaymentMethodPreferenceEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->shippingPreference)) {
            $json['shipping_preference']       = ShippingPreferenceEnum::checkValue($this->shippingPreference);
        }
        ...
        if (isset($this->landingPage)) {
            $json['landing_page']              = PayPalExperienceLandingPageEnum::checkValue($this->landingPage);
        }
        if (isset($this->userAction)) {
            $json['user_action']               = PayPalExperienceUserActionEnum::checkValue($this->userAction);
        }
        if (isset($this->paymentMethodPreference)) {
            $json['payment_method_preference'] =
                PayeePaymentMethodPreferenceEnum::checkValue(

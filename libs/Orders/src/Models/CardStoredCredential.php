...
class CardStoredCredential implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $usage = StoredPaymentSourceUsageTypeEnum::DERIVED;
     ...
     * @factory \OrdersLib\Models\PaymentInitiatorEnum::checkValue
     */
     ...
     * @required
     * @maps payment_type
     * @factory \OrdersLib\Models\StoredPaymentSourcePaymentTypeEnum::checkValue
     */
     ...
     *
     * @maps usage
     * @factory \OrdersLib\Models\StoredPaymentSourceUsageTypeEnum::checkValue
     */
    ...
    {
        $json = [];
        $json['payment_initiator']                          = PaymentInitiatorEnum::checkValue($this->paymentInitiator);
        $json['payment_type']                               =
            StoredPaymentSourcePaymentTypeEnum::checkValue(
                $this->paymentType
            );
        if (isset($this->usage)) {
            $json['usage']                                  =
                StoredPaymentSourceUsageTypeEnum::checkValue(
                    $this->usage
                );
        }

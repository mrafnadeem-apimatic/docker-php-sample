...
class CardVerification implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $method = CardVerificationMethodEnum::SCA_WHEN_REQUIRED;
     ...
     *
     * @maps method
     * @factory \OrdersLib\Models\CardVerificationMethodEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->method)) {
            $json['method'] = CardVerificationMethodEnum::checkValue($this->method);
        }

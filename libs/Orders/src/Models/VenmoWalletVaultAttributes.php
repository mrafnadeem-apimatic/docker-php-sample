...
class VenmoWalletVaultAttributes implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $customerType = VenmoPaymentTokenCustomerTypeEnum::CONSUMER;
     ...
     *
     * @maps usage_pattern
     * @factory \OrdersLib\Models\VenmoPaymentTokenUsagePatternEnum::checkValue
     */
     ...
     * @required
     * @maps usage_type
     * @factory \OrdersLib\Models\VenmoPaymentTokenUsageTypeEnum::checkValue
     */
     ...
     *
     * @maps customer_type
     * @factory \OrdersLib\Models\VenmoPaymentTokenCustomerTypeEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->usagePattern)) {
            $json['usage_pattern']                  =
                VenmoPaymentTokenUsagePatternEnum::checkValue(
                    $this->usagePattern
                );
        }
        $json['usage_type']                         = VenmoPaymentTokenUsageTypeEnum::checkValue($this->usageType);
        if (isset($this->customerType)) {
            $json['customer_type']                  =
                VenmoPaymentTokenCustomerTypeEnum::checkValue(
                    $this->customerType
                );
        }

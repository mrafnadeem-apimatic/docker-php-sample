...
class OrderApplicationContext implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $landingPage = OrderApplicationContextLandingPageEnum::NO_PREFERENCE;

    /**
     * @var string|null
     */
    private $shippingPreference = OrderApplicationContextShippingPreferenceEnum::GET_FROM_FILE;

    /**
     * @var string|null
     */
    private $userAction = OrderApplicationContextUserActionEnum::CONTINUE_;
     ...
     *
     * @maps landing_page
     * @factory \OrdersLib\Models\OrderApplicationContextLandingPageEnum::checkValue
     */
     ...
     * @factory \OrdersLib\Models\OrderApplicationContextShippingPreferenceEnum::checkValue
     */
     ...
     *
     * @maps user_action
     * @factory \OrdersLib\Models\OrderApplicationContextUserActionEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->landingPage)) {
            $json['landing_page']          = OrderApplicationContextLandingPageEnum::checkValue($this->landingPage);
        }
        if (isset($this->shippingPreference)) {
            $json['shipping_preference']   =
                OrderApplicationContextShippingPreferenceEnum::checkValue(
                    $this->shippingPreference
                );
        }
        if (isset($this->userAction)) {
            $json['user_action']           = OrderApplicationContextUserActionEnum::checkValue($this->userAction);
        }

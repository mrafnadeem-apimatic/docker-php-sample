...
class PayPalWalletVaultInstruction implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $customerType = PayPalPaymentTokenCustomerTypeEnum::CONSUMER;
     ...
     *
     * @maps store_in_vault
     * @factory \OrdersLib\Models\StoreInVaultInstructionEnum::checkValue
     */
     ...
     *
     * @maps usage_pattern
     * @factory \OrdersLib\Models\PayPalPaymentTokenUsagePatternEnum::checkValue
     */
     ...
     * @required
     * @maps usage_type
     * @factory \OrdersLib\Models\PayPalPaymentTokenUsageTypeEnum::checkValue
     */
     ...
     *
     * @maps customer_type
     * @factory \OrdersLib\Models\PayPalPaymentTokenCustomerTypeEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->storeInVault)) {
            $json['store_in_vault']                 = StoreInVaultInstructionEnum::checkValue($this->storeInVault);
        }
        ...
        if (isset($this->usagePattern)) {
            $json['usage_pattern']                  =
                PayPalPaymentTokenUsagePatternEnum::checkValue(
                    $this->usagePattern
                );
        }
        $json['usage_type']                         = PayPalPaymentTokenUsageTypeEnum::checkValue($this->usageType);
        if (isset($this->customerType)) {
            $json['customer_type']                  =
                PayPalPaymentTokenCustomerTypeEnum::checkValue(
                    $this->customerType
                );
        }

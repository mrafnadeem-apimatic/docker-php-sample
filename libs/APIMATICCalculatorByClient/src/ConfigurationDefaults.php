...
class ConfigurationDefaults
{
    ...
    public const ENVIRONMENT_3 = Models\OperationTypeEnum::SUM;

    public const ENVIRONMENT_2 = 'Qaws2W233WedeRe4T56G6Vref2';
    ...
    public const _ALL = [
        ...
        'environment3' => self::ENVIRONMENT_3,
        'environment2' => self::ENVIRONMENT_2
    ];
}

...
class APIMATICCalculatorByClientClientBuilder
{
    /**
     * @var array
     */
    ...
    public function environment3(string $environment3): self
    {
        $this->config['environment3'] = $environment3;
        return $this;
    }

    /**
     * @see APIMATICCalculatorByClientClientBuilder::customHeaderAuthenticationCredentials
     *
     ...
     * @return $this
     */
    public function environment2(string $environment): self
    {
    ...
    public function build(): APIMATICCalculatorByClientClient
    {
        return new APIMATICCalculatorByClientClient($this->config);
    }
}

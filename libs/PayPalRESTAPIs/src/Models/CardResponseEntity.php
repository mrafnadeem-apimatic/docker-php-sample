...
class CardResponseEntity implements \JsonSerializable
{
    ...
    /**
     * Converts the CardResponseEntity object to a human-readable string representation.
     *
     * @return string The string representation of the CardResponseEntity object.
     */

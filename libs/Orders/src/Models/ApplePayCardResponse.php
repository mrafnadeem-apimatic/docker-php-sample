...
class ApplePayCardResponse implements \JsonSerializable
{
     ...
     *
     * @maps brand
     * @factory \OrdersLib\Models\CardBrandEnum::checkValue
     */
     ...
     *
     * @maps type
     * @factory \OrdersLib\Models\CardTypeEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->brand)) {
            $json['brand']                 = CardBrandEnum::checkValue($this->brand);
        }
        if (isset($this->availableNetworks)) {
            $json['available_networks']    = CardBrandEnum::checkValue($this->availableNetworks);
        }
        if (isset($this->type)) {
            $json['type']                  = CardTypeEnum::checkValue($this->type);
        }

...
| `card` | `mixed` | Optional | The payment card information. | getCard(): | setCard( card): void |
...
| `assuranceDetails` | `mixed` | Optional | - | getAssuranceDetails(): | setAssuranceDetails( assuranceDetails): void |

...
class PaymentMethodPreference implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $payeePreferred = PayeePaymentMethodPreferenceEnum::UNRESTRICTED;

    /**
     * @var string|null
     */
    private $standardEntryClassCode = StandardEntryClassCodeEnum::WEB;
     ...
     * @factory \OrdersLib\Models\StandardEntryClassCodeEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->payeePreferred)) {
            $json['payee_preferred']           = PayeePaymentMethodPreferenceEnum::checkValue($this->payeePreferred);
        }
        if (isset($this->standardEntryClassCode)) {
            $json['standard_entry_class_code'] = StandardEntryClassCodeEnum::checkValue($this->standardEntryClassCode);
        }
